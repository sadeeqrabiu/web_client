...
const ProductSections = () => {
  return (
    <div className="w-full px-4 py-16 sm:px-8 bg-white">
      {/* Header */}
      {/* <div className="mb-12">
      ...
      <div className="mb-20">
        ...
        <div className="relative w-full lg:w-1/2">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-left p-4">
              ...
              <p className="text-gray-700 mb-6 text-left text-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-100 mb-6">
                <div>
              ...
              <Link
                href="/connect"
                className="inline-block w-40 bg-blue-100 text-blue-600 px-6 py-2 rounded-full hover:bg-blue-200 transition-colors"
              >
                Connect Wallet
              </Link>
            </div>
    ...
    >
      ...
      <div className="px-10 py-16 md:p-16 md:w-1/2 text-white">
        <div className="text-red-500 mb-2 ">Rebuild. Reimagine</div>
      ...
      <div className="px-10 pb-16 md:px-16 text-black">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/3 mb-10 mt-10 md:mb-0">
            <img 
              src="/images/logo.svg" 
        ...
        <div className="flex space-x-4 mt-4">
                ...
                <a href="https://github.com" className="text-black hover:text-gray-700" aria-label="GitHub">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://t.me/yourgroup" className="text-black hover:text-gray-700" aria-label="Telegram">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.96 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" />
                  </svg>
                </a>
                <a href="https://discord.com" className="text-black hover:text-gray-700" aria-label="Discord">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:contact@example.com" className="text-black hover:text-gray-700" aria-label="Email">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex flex-auto md:flex-row space-y-2 md:space-y-0 md:space-x-6 text-sm">
            <a href="#" className="hover:underline">Privacy Policy</a>
            <a href="#" className="hover:underline">Terms of Conditions</a>
            <span>© 2023 Roll Protocol. All Rights Reserved.</span>
        </div>
    </div>
    </div>
  )
